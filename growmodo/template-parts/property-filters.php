...
$growmodo_pills = array(
	...
	array(
		'key'     => 'beds',
		'icon'    => 'bed',
		'label'   => __( 'Bedrooms', 'growmodo' ),
		'match'   => 'min',
		'options' => growmodo_minimum_options( $growmodo_facets['beds'] ),
	),
	array(
		'key'     => 'baths',
		'icon'    => 'bath',
		'label'   => __( 'Bathrooms', 'growmodo' ),
		'match'   => 'min',
		'options' => growmodo_minimum_options( $growmodo_facets['baths'] ),
	),
);
